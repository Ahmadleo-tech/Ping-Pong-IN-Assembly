...
hyphen: db '-------------------------'
creator: db 'Made by '
studentName:db 'Muhammad Aizazullah 23F-0664 and Ahmad Abdullah 23F-0763       '
...
press: db 'Press any key to start the game...' ; length = 32
...
outerLoop: mov di, word[bp+4] ; Load starting position of line
mov ax, 0x0700
mov cx, 25
...
; printing game over on screen along with which player wins and their scores
